<template>
  ...
  <van-cell center :title="`聊天大厅`" :label="`官方聊天室`" @click="toHallChat">
    <template #icon>
  ...
  <van-cell center :title="`DeepSeek`"  @click="toAiChat">
    <template #icon>
      <van-image round :src="`https://q8.itc.cn/q_70/images03/20250209/d195292078c346f2a101de767d602bf2.jpeg`" width="75" height="60"/>
    </template>
    <template #right-icon>
      <van-tag type="primary">官方</van-tag>
    </template>
